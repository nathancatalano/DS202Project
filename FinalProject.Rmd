...
```
The plot shows the league leaders in runs scored for each year from 1998 to 2021. For example, the New York Yankees led the league in 1998 and the Houston Astros led the league in 2021.  
