...
### What are the most common ERA ranges for pitchers in the 1980s and 1990s compared to since 2000s

```{r}
era80 = Pitching %>% filter(between(yearID,1980,1999))
era00 = Pitching %>% filter(yearID >=2000)
```
